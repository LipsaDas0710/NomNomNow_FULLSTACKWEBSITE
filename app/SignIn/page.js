...
//             console.log("Redirecting to:", `/${session.user.urlname}/Home`);
...
//         signIn("google", { callbackUrl: "/SignIn" }); // redirect after login
//     };
    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 border rounded">
            ...
            <div>Already have an account?
                <span onClick={() => router.push('/Login')} className='hover:text-blue-500 cursor-pointer ml-1'>
                    Login
                </span>
            </div>
