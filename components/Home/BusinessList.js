...
// import { getPixabayImage } from '../../Shared/GlobalApi';
...
//   return (
//      <div className='flex overflow-scroll overflow-x-auto gap-4 scrollbar-hide scroll-smooth'>
//       {businessList.slice(0, 7).map((item, index) => {
//         const isSelected = selectedBusiness?.id === item.id;
//         const imageUrl = imageMap[item.cuisine] || '/placeholder.jpeg';
//         return (
//           <div
//             key={index}
...
//             }`}
//           >
//             <BusinessItem business={item}  image={imageMap[item.cuisine] || '/placeholder.jpeg'} />
//           </div>
//         );
//       })}
//     </div>
